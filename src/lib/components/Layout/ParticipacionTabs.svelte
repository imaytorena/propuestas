...
<div class="block md:hidden mb-2 flex w-full flex-col items-start justify-start gap-1">
	{#each [{ name: 'ideas', label: 'Ideas' }, { name: 'propuestas', label: 'Propuestas' }, { name: 'actividades', label: 'Actividades' }, { name: 'participacion', label: 'Participación' }] as element}
				...
				>
					...
					<svg xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24">
                        <g
							...
							stroke-width="2"
							>
                            <path d="m11 9l3 3l-3 3" /><path d="M3 12a9 9 0 1 0 18 0a9 9 0 0 0-18 0" />
                        </g>
					</svg>
				</a>
			</div>
	...
	<div class="flex flex-col items-start">
		<h2 class="mb-2 text-3xl font-bold flex items-center gap-1">
            ...
            <div class="block md:hidden">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"><path d="m15 11l-3 3l-3-3"/><path d="M12 3a9 9 0 1 0 0 18a9 9 0 0 0 0-18"/></g></svg>
            </div>
		</h2>
