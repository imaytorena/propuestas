<script lang="ts">
	let { id, nombre, descripcion, estado, fechaEntrega, categorias, comunidades } = $props();
</script>

<div class="container mx-auto px-4 py-8">
	<div class="mx-auto max-w-4xl">
			<div class="rounded-lg bg-base-100 p-8 shadow-lg">
				...
				<div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2">
					<div class="flex flex-col gap-4 rounded-lg bg-base-200 bg-opacity-50 p-4">
						
						<div class="flex flex-col items-start">
							<h3 class="mb-2 font-semibold text-gray-700">Miembros</h3>
							<div class="flex flex-col items-start">
								20 miembros
					...
					<div class="rounded-lg bg-base-200 bg-opacity-50 p-4">
						<h3 class="mb-2 font-semibold text-gray-700">Categorías</h3>
				...
				<div class="border-t pt-6">
					<div class="flex items-center justify-between">
						<div class="flex items-center text-gray-500">
							...
							<span>Fecha de entrega: {fechaEntrega}</span>
						</div>

						<div class="space-x-3">
							<button class="btn btn-neutral rounded-md text-white transition-colors">
								Enviar mi opinión
							</button>
						</div>
					</div>
